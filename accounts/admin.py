...
class DriverAdmin(admin.ModelAdmin):
    """Driver Admin with verification features"""
    list_display = [
        'names', 'vehicle_plate', 'vehicle_type', 'user_phone',
        'is_verified', 'is_available', 'verified_at', 'verification_status'
    ]
    list_filter = ['is_verified', 'is_available', 'vehicle_type', 'created_at']
    search_fields = [
    ...
    readonly_fields = [
        'user_link', 'created_at', 'updated_at', 'verified_at',
        'license_image_link', 'vehicle_image_link'
    ]
    list_editable = ['is_verified', 'is_available']
    actions = ['verify_drivers', 'unverify_drivers', 'make_available', 'make_unavailable']
    ...
    make_unavailable.short_description = "Mark selected drivers as unavailable"
