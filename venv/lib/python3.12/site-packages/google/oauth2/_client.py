...
def _lookup_trust_boundary(request, url, headers=None):
    ...
    Returns:
        Mapping[str,list|str]: A dictionary containing
            "location" as a list of allowed location as strings and
            "encodedlocation" as a hex string.
            e.g:
            {
                "location": [
                    "us-central1", "us-east1", "europe-west1", "asia-east1"
                ],
                "encodedlocation": "0xA30"
            }
    ...
    # In case of no-op response, the "location" list may or may not be present as an empty list.
    if "encodedlocation" not in response_data:
