    ...
    def create_bucket(
        ...
        Args:
            ...
            location (str):
                ...
                `data_location` should be set in conjunction. See:
                https://cloud.google.com/storage/docs/location
            data_location (list of str):
                (Optional) The list of regional location of a custom dual-region bucket.
                Dual-regions require exactly 2 regional location. See:
                https://cloud.google.com/storage/docs/location
            predefined_acl (str):
        ...
        with create_trace_span(name="Storage.Client.createBucket"):
            ...
            if data_location is not None:
                properties["customPlacementConfig"] = {"datalocation": data_location}
