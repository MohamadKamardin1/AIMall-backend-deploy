...
class Bucket(_PropertyMixin):
    ...
    def create(
        ...
        :param location: (Optional) The location of the bucket. If not passed,
                         ...
                         https://cloud.google.com/storage/docs/bucket-location
    ...
    def data_location(self):
        """Retrieve the list of regional location for custom dual-region buckets.
        ...
        return custom_placement_config.get("datalocation")
