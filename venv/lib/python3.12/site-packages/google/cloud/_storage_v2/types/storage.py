...
class ComposeObjectRequest(proto.Message):
    ...
    Attributes:
        ...
        kms_key (str):
            ...
            ``projects/my-project/location/my-location/keyRings/my-kr/cryptoKeys/my-key``,
...
class RewriteObjectRequest(proto.Message):
    ...
    Attributes:
        ...
        max_bytes_rewritten_per_call (int):
            ...
            where the source and destination span location and/or
...
class Bucket(proto.Message):
    ...
    Attributes:
        ...
        location (str):
            ...
            [https://developers.google.com/storage/docs/concepts-techniques#specifyinglocation"][developer's
        ...
        custom_placement_config (google.cloud._storage_v2.types.Bucket.CustomPlacementConfig):
            ...
            placement for a
            [https://cloud.google.com/storage/docs/location#location-dr][configurable
            dual-region].
    ...
    class CustomPlacementConfig(proto.Message):
        ...
        `here <https://cloud.google.com/storage/docs/location>`__.

        Attributes:
            data_location (MutableSequence[str]):
                Optional. List of location to use for data
                placement.
        """

        data_location: MutableSequence[str] = proto.RepeatedField(
            proto.STRING,
            number=1,
        )
