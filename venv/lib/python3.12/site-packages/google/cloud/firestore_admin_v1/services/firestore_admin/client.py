...
from google.cloud.location import location_pb2  # type: ignore
...
class FirestoreAdminClient(metaclass=FirestoreAdminClientMeta):
    ...
    def backup_path(
        ...
        return "projects/{project}/location/{location}/backups/{backup}".format(
            project=project,
            location=location,
            backup=backup,
        )
    ...
    def parse_backup_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/location/(?P<location>.+?)/backups/(?P<backup>.+?)$",
            path,
        )
    ...
    def location_path(
        ...
        return "projects/{project}/location/{location}".format(
            project=project,
            location=location,
        )
    ...
    def parse_location_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/location/(?P<location>.+?)$", path)
        return m.groupdict() if m else {}
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.firestore_admin_v1.types.ListDatabasesRequest, dict]):
                ...
                Databases in all location for a
                project.
            parent (str):
                Required. A parent name of the form
                ``projects/{project_id}``
        ...
        *,
        ...
        Args:
            ...
            name (str):
                ...
                Format is
                ``projects/{project}/location/{location}/backups/{backup}``.
        ...
        *,
        ...
        Args:
            ...
            parent (str):
                ...
                Format is ``projects/{project}/location/{location}``.
                Use ``{location} = '-'`` to list backups from all
                location for the given project. This allows listing
                backups from a single location or from all location.
