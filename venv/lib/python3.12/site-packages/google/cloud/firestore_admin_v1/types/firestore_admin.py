...
class ListDatabasesRequest(proto.Message):
    r"""A request to list the Firestore Databases in all location
    for a project.
...
class ListDatabasesResponse(proto.Message):
    ...
    Attributes:
        ...
        unreachable (MutableSequence[str]):
            ...
            projects/some_project/location/some_location This can
...
class ListBackupsRequest(proto.Message):
    ...
    Attributes:
        parent (str):
            ...
            Format is ``projects/{project}/location/{location}``. Use
            ``{location} = '-'`` to list backups from all location for
            the given project. This allows listing backups from a single
            location or from all location.
        filter (str):
...
class ListBackupsResponse(proto.Message):
    ...
    Attributes:
        ...
        unreachable (MutableSequence[str]):
            List of location that existing backups were
            ...
            location unable to be reached here. The request
...
class RestoreDatabaseRequest(proto.Message):
    ...
    Attributes:
        ...
        backup (str):
            ...
            Format is:
            ``projects/{project_id}/location/{location}/backups/{backup}``
