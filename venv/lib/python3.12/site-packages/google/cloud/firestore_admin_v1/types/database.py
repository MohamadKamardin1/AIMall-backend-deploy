...
class Database(proto.Message):
    ...
    Attributes:
        ...
        location_id (str):
            ...
            location are listed at
            https://cloud.google.com/firestore/docs/location.
    ...
    class CmekConfig(proto.Message):
        ...
        Attributes:
            kms_key_name (str):
                ...
                https://cloud.google.com/kms/docs/location.

                The expected format is
                ``projects/{project_id}/location/{kms_location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}``.
            active_key_version (MutableSequence[str]):
                ...
                The expected format is
                ``projects/{project_id}/location/{kms_location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}/cryptoKeyVersions/{key_version}``.
        """
