...
class ListlocationRequest(_message.Message):
...
class ListlocationResponse(_message.Message):
    __slots__ = ("location", "next_page_token")
    ...
    def __init__(
        self,
        location: _Optional[_Iterable[_Union[Location, _Mapping]]] = ...,
