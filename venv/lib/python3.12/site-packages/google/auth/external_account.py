...
class Credentials(
    ...
    **IMPORTANT**:
    ...
    def is_workforce_pool(self):
        ...
        # //iam.googleapis.com/location/$location/workforcePools/$poolId/providers/$providerId
        p = re.compile(r"//iam\.googleapis\.com/location/[^/]+/workforcePools/")
    ...
    def project_number(self):
        ...
        # //iam.googleapis.com/projects/$PROJECT_NUMBER/location/...
    ...
    def _build_trust_boundary_lookup_url(self):
        ...
        # Audience format: //iam.googleapis.com/projects/PROJECT_NUMBER/location/global/workloadIdentityPools/POOL_ID/providers/PROVIDER_ID
        workload_match = re.search(
            r"projects/([^/]+)/location/global/workloadIdentityPools/([^/]+)",
            self._audience,
        )
        if workload_match:
            ...
            # Audience format: //iam.googleapis.com/location/global/workforcePools/POOL_ID/providers/PROVIDER_ID
            workforce_match = re.search(
                r"location/[^/]+/workforcePools/([^/]+)", self._audience
            )
            if workforce_match:
    ...
    def _get_mtls_cert_and_key_paths(self):
        """Gets the file location for a certificate and private key file
        ...
        Returns:
            Tuple[str, str]: The cert and key file location as strings in a tuple.
