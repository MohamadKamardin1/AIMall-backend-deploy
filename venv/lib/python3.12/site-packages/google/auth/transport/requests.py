...
class _MutualTlsAdapter(requests.adapters.HTTPAdapter):
    ...
    def __init__(self, cert, key):
        ...
        ctx_poolmanager.load_verify_location(cafile=certifi.where())
        ...
        ctx_proxymanager.load_verify_location(cafile=certifi.where())
