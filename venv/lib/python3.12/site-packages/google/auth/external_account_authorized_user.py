...
Example credential:
{
  ...
  "audience": "//iam.googleapis.com/location/global/workforcePools/$WORKFORCE_POOL_ID/providers/$PROVIDER_ID",
...
class Credentials(
    ...
    **IMPORTANT**:
    ...
    def _build_trust_boundary_lookup_url(self):
        ...
        match = re.search(r"location/[^/]+/workforcePools/([^/]+)", self._audience)
